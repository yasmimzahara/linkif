    ...
    <div class="container max-w-6xl mx-auto mt-20">
        <div class="mb-4">
            ...
            <div class="flex justify-end">
                <a href="{{ route('company.internships.create')}}" class="px-4 py-2 rounded-md bg-green-600 text-green-100 hover:bg-green-800">
                    {{ __('Criar Vaga') }}
                </a>
            </div>
        </div>
                        ...
                        <tbody class="bg-white">
                            ...
                            <tr>
                                ...
                                <td class="text-sm font-medium leading-5 text-center whitespace-no-wrap border-b border-gray-200 ">
                                    <a href="{{ route('company.internships.show', $internship->id) }}" class="text-indigo-600 hover:text-indigo-900">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z" />
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                                        </svg>
                                    </a>
                                    <form action="{{ route('company.internships.destroy', $internship->id) }}" method="post" onsubmit="return confirm('{{ __('Tem certeza?') }}');">
