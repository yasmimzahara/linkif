<x-app-layout>
    <div class="container max-w-6xl mx-auto mt-20">
        <div class="mb-4">
            <h1 class="text-3xl font-bold decoration-gray-400">{{  __('Admins') }}</h1>
            ...
            <div class="flex justify-end">
                <a href="{{ route('admin.admins.create')}}" class="px-4 py-2 rounded-md bg-green-600 text-green-100 hover:bg-green-800">
                    {{ __('Criar Admin') }}
                </a>
            </div>
        </div>
                        ...
                        <tbody class="bg-white">
                            ...
                            <tr>
                                ...
                                <td
                                    ...
                                    <span> {{ $admin->created_at->isoFormat("LLLL") }}</span>
                                </td>
                                ...
                                <td class="text-sm font-medium leading-5 text-center whitespace-no-wrap border-b border-gray-200 ">
                                    ...
                                    <a href="{{ route('admin.admins.editPassword', $admin->id) }}" class="text-indigo-600 hover:text-indigo-900">
                                        password
                                    </a>
                                    <form action="{{ route('admin.admins.destroy', $admin->id) }}" method="post" onsubmit="return confirm('{{ __('Tem certeza?') }}');">
