<x-app-layout>
    <div class="container max-w-6xl mx-auto mt-20">
        <div class="mb-4">
            <h1 class="text-3xl font-bold decoration-gray-400">{{  __('Candidaturas') }}</h1>
            ...
            <form method="GET" action="{{ route('admin.applications.index') }}">
                <input placeholder="{{ __('Procurar Empresa') }}" type="text" name="company_name" value="{{ request()->company_name }}">
                <input placeholder="{{ __('Procurar Vaga') }}" type="text" name="internship_title" value="{{ request()->internship_title }}">
                <input placeholder="{{ __('Procurar Estudante') }}" type="text" name="student_name" value="{{ request()->student_name }}">
                        ...
                        <tbody class="bg-white">
                            ...
                            <tr>
                                ...
                                <td class="text-sm font-medium leading-5 text-center whitespace-no-wrap border-b border-gray-200 ">
                                    ...
                                    <form action="{{ route('admin.applications.destroy', $application->id) }}" method="post" onsubmit="return confirm('{{ __('Tem certeza?') }}');">
